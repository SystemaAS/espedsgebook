				...
				<table id="containerdatatableTable" cellspacing="2" align="left" width="100%">
					...
					<table id="customerList" class="display compact cell-border" width="100%">
						...
						<tr class="tableHeaderField">
						    <th class="text14">&nbsp;<spring:message code="systema.ebooking.childwindow.customer.label.customer.nr"/></th>  
						    <th class="text14">&nbsp;<spring:message code="systema.ebooking.childwindow.customer.label.address.name"/></th>
		                    <th class="text14">&nbsp;<spring:message code="systema.ebooking.childwindow.customer.label.address.address"/></th>
		                    <th class="text14">&nbsp;<spring:message code="systema.ebooking.childwindow.customer.label.address.postnrStedLand"/></th>
		                    <th class="text14">&nbsp;<spring:message code="systema.ebooking.childwindow.customer.label.customer.name"/></th>  
						    <th class="text14">&nbsp;<spring:message code="systema.ebooking.childwindow.customer.label.customer.address"/></th>  
		                ...
		                <c:forEach var="record" items="${model.customerList}" varStatus="counter">    
			               ...
			               <td class="text14MediumBlue" style="cursor:pointer;" id="kundnr_${record.kundnr}@navn_${record.navn}@adr1_${record.gateAdr}@adr2_${record.adresse2}@postnrsted_${record.postnrSted}@kundname_${record.kundNavn}@kundaddress_${record.kundPnSt}@counter_${counter.count}">&nbsp;${record.kundnr}</td>
			               <td class="text14" >&nbsp;${record.navn}</td>
			               <td class="text14" >&nbsp;${record.gateAdr}&nbsp;${record.adresse2}</td>
			               <td class="text14" >&nbsp;${record.postnrSted}&nbsp;${record.land}</td>
			               <td class="text14" >&nbsp;${record.kundNavn}</td>
			               <td class="text14" >&nbsp;${record.kundPnSt}</td>
